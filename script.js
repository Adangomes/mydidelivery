...
function abrirModalBatata(tamanho) { // tamanho pode ser 'P' (600g) ou 'G' (1kg)
    ...
    // Esconde o que é exclusivo de pizza
    ...
    // 2. Busca todos os produtos que pertencem a essa Tag

    // O admin deve colocar a tag no campo "categoria" dos sabores
    ...
    // 3. Renderiza as opções (Sabores de Batata, por exemplo)

    itensEncontrados.forEach(item => {

        // Pega o preço baseado no que o admin clicou (600g ou 1kg)

        // Se o botão principal era 600g (P), pegamos o preço 'P' do sabor
    ...
    document.getElementById("secao-adicionais").style.display = "none"; // Admin decide se mostra depois
...
// Função auxiliar para fechar e adicionar
